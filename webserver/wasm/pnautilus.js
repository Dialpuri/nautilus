...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'pnautilus.data';
      var REMOTE_PACKAGE_BASE = 'pnautilus.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_pnautilus.data');

      };
      Module['addRunDependency']('datafile_pnautilus.data');
    ...
    loadPackage({"files": [{"filename": "/nautilus_demo.mtz", "start": 0, "end": 4130768}, {"filename": "/nautilus_lib.pdb", "start": 4130768, "end": 4813197}], "remote_package_size": 4813197});
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'pnautilus.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('pnautilus.wasm', import.meta.url).href;
}
...
export default nautilus_module;